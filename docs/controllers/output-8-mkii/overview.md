...
| Front panel | Status LED, 8 RGB channel indicators, configurable [front button](/docs/controllers/shared/front-button) |
...
- [Multistate Relay™](multistate-relay) — what makes the MKII different from the MKI
