...
description: "Specifications for the Input 16"
---
...
| Channel breakouts | Inputs 9–16 on two included breakout boards, connected by a standard Ethernet cable |
...
The Input 16 has audio out — same hardware as the rest of the lineup. Useful when a show triggered by an Input 16 input also needs to play sound.
