...
To get started with your Input 8, you will need to connect it to your IgorBox account. You can do this by following the instructions in the [Connecting your IgorBox Guide](/docs/legacy/igorbox-mki/connect).
...
You can read more about wiring the I/O connector block in the [Wiring Guide](/docs/legacy/igorbox-mki/input-8/wiring-guide).
