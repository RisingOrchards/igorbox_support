...
To get started with your Output 8, you will need to connect it to your IgorBox account. You can do this by following the instructions in the [Connecting your IgorBox Guide](/docs/igorbox/connect).
...
You can read more about wiring the I/O connector block in the [Wiring Guide](/docs/igorbox/output-8/wiring-guide).
...
_you can read more about error codes in the [Error Codes Guide](/docs/igorbox/output-8/error-codes)_
