...
To get started with your Input 8, you will need to connect it to your IgorBox account. You can do this by following the instructions in the [Connecting your IgorBox Guide](/docs/igorbox/connect).

Once your Input 8 is connected to your account, you can start linking it to trigger compositions.

## The Front Panel

![Front Panel](/img/ibi8/ibi8-panel.png)
...
You can read more about wiring the I/O connector block in the [Wiring Guide](/docs/igorbox/input-8/wiring-guide).
...
The voltage you supply will be exposed on the "Power" section in the middle of the I/O connector block. This can be a convenient way to get power to devices through jumpering (which we'll cover in the [Wiring Guide](/docs/igorbox/output-8/wiring-guide)).
...
_you can read more about error codes in the [Error Codes Guide](/docs/igorbox/input-8/error-codes)_
