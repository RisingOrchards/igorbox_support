---
sidebar_position: 1
description: "What IgorBox Studio is"
---
...
- New to all of this? [Getting Started](getting-started) walks through your first show end-to-end.
- Have a controller online and want to make it do something? Jump to the [timeline editor basics](timeline-editor/basics).
- Building game logic? Start with [Logic Rules](logic-rules/overview).
