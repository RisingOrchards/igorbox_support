...
When a controller comes back online after a firmware update, the studio now picks it up instantly instead of waiting for the previous connection to time out. This alos fixes a bug where a controller will have a green status led but just shows "connecting" on the controller's overview page for about 60 seconds. 
